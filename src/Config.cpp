...
void Config::AddConfigDescriptions(po::options_description& config)
{
...
Config::Config(int &/*argc*/, char **&/*argv*/)
{
    ...
    /*
      option:
        -list available lens, cameras, backends, lights
        -choose a camera/backend
     */
